...
function dashboard(s){
 ...
 return `<header class="football-title"><div><small>${s.year} 赛季 · ${esc(getDivision(d).name)} · ${md(s.date)}</small><h1>${esc(name(own))}</h1></div><div class="manager-actions"><a class="football-link" href="#market">转会与合同 ↗</a><a class="football-link" href="#squad/${own}">球队阵容 ↗</a></div></header>
