...
const originalClubs = [
  {id:'sky',name:'皇家之鹰',city:'crown-city',league:'closed',short:'SKY',founded:288},
  {id:'silver-fc',name:'金色雄鹰',city:'silver-city',league:'closed',short:'SIL',founded:288},
  {id:'crown-fc',name:'新拓者',city:'crown-city',league:'crown-league',short:'CRN',founded:231},
  {id:'bay-fc',name:'科技谷矢量',city:'silver-city',league:'silver-league',short:'BAY',founded:248},
  {id:'harbor',name:'潮起者',city:'haimen',league:'lima-league',short:'HBR',founded:240},
  {id:'isles-fc',name:'盐河浪人',city:'isle-city',league:'lima-league',short:'ISL',founded:256},
  {id:'iron-fc',name:'黑岩矿工',city:'iron-city',league:'liberlin-league',short:'IRN',founded:219},
  {id:'pine-fc',name:'铸铁港红魔',city:'pine',league:'liberlin-league',short:'PNE',founded:236},
  {id:'bridge',name:'拓荒斯巴达',city:'jiangqiao',league:'sichuan-league',short:'JQ',founded:243},
  {id:'rong-fc',name:'沙暴骑士',city:'rong-city',league:'sichuan-league',short:'RNG',founded:252},
];
...
export const academies = [
  ...
  {id:'horizon',name:'皇家远穹体育学院',city:'silver-city',kind:'皇家学院',founded:281,text:'位于裴渡，与晨星学院长期竞争。毕业生可参加大都会联盟选秀。'},
  {id:'bridge-academy',name:'拓荒斯巴达青训',city:'jiangqiao',kind:'俱乐部青训',founded:250,text:'拓荒斯巴达所属青训，主要培养本地球员。'},
  {id:'iron-academy',name:'黑岩矿工青训',city:'iron-city',kind:'俱乐部青训',founded:229,text:'黑岩矿工所属青训，退役名宿参与训练。'},
];
export const families = [
  {id:'lin',name:'江桥林家',origin:'jiangqiao',type:'普通家庭',text:'林承岳在拓荒斯巴达退役，儿子林知远效力大都会皇家之鹰。',parent:null},
...
export const players = [
  person('lin','林知远',19,'中场','jiangqiao','sky','morning',313,317,{family:'lin',number:8,reputation:78,foot:'右脚',height:181,skills:[['传球',78],['视野',81],['控球',76]],honors:[{year:317,text:'大都会联盟选秀状元'}],career:[{year:313,text:'离开江桥，进入皇家晨星体育学院',type:'academy',target:'morning'},{year:317,text:'以总第 1 顺位被皇家之鹰选中',type:'draft',target:'317'},{year:318,text:'职业首个完整赛季 · 8 号',type:'club',target:'sky'}]}),
  person('father','林承岳',43,'中后卫','jiangqiao',null,'bridge-academy',287,292,{family:'lin',retired:true,number:5,reputation:65,lastClub:'bridge',skills:[['防守',71],['预判',75],['力量',70]],honors:[{year:305,text:'拓荒斯巴达赛季队长'}],career:[{year:292,text:'从江桥青训进入一线队',type:'club',target:'bridge'},{year:305,text:'出任拓荒斯巴达队长',type:'club',target:'bridge'},{year:312,text:'在江桥结束职业生涯',type:'club',target:'bridge'}]}),
  ...
  person('shen','沈序',24,'门将','pine','silver-fc','morning',309,313,{number:1,reputation:83,skills:[['反应',84],['扑救',82],['出击',76]],honors:[{year:317,text:'大都会联盟最佳阵容'}]}),
  person('royal-player','星垣·裴枝 维安',22,'中场','silver-city','crown-fc','horizon',311,315,{family:'royal-bay',number:6,reputation:69,honors:[{year:317,text:'新拓者赛季突破球员'}]}),
  person('yan','严柏',30,'中后卫','iron-city','iron-fc','iron-academy',300,306,{number:4,reputation:88,honors:[{year:317,text:'利柏林超级联赛最佳球员'}]}),
  person('ji','季宁',21,'前锋','isle-city','isles-fc',null,0,0,{number:9,reputation:72,honors:[{year:317,text:'盐河浪人赛季最佳青年球员'}]}),
  person('tang','唐星禾',23,'边锋','south-rong','rong-fc',null,0,0,{number:7,reputation:75,honors:[{year:317,text:'沙暴骑士赛季最佳球员'}]}),
  person('wen','温澜',26,'中场','tide','bay-fc','horizon',307,312,{number:14,reputation:74,honors:[{year:317,text:'科技谷矢量队长'}]}),
];
...
for(let year=288;year<=317;year++) {
  ...
  if(id!=='lin') {
    ...
    players.push(person(id,id==='he'?'何沅':nameInfo.name,age,index%3?'中场':'前锋',id==='he'?'qinglu':otherCities[index%otherCities.length],retired?null:club,index%2?'morning':'horizon',year-5,year,{...(id==='he'?{}:nameInfo),retired,lastClub:retired?club:undefined,reputation:id==='he'?91:67+(index%5)*4,number:9,skills:[['传球',79],['视野',81],['控球',78]],honors:[{year,text:'大都会联盟选秀状元'}],career:[{year,text:`以总第 1 顺位被${clubs.find(c=>c.id===club).name}选中`,type:'draft',target:String(year)},...(retired?[{year:year+15,text:'退役',type:'club',target:club}]:[])]}));
  }
